...
export const Route = createFileRoute("/login")({
  ...
  head: () => ({
    meta: [
      { title: "Đăng nhập — Master Sale AI" },
      { name: "description", content: "Đăng nhập vào hệ thống đào tạo Sale Master AI" },
    ],
  }),
});
    ...
    <div className="relative flex min-h-screen" style={{ backgroundColor: "#121212" }}>
      ...
      >
        <div className="flex h-full flex-col items-center justify-center bg-black/40 p-8">
          ...
          <h2 className="max-w-md text-center text-3xl font-bold text-white">
            Chinh phục doanh số cùng{" "}
            <span className="text-yellow-400">KOL AI System</span>
          </h2>
          <p className="mt-3 max-w-sm text-center text-sm text-white/70">
            Nền tảng đào tạo giúp bạn trở thành Sale chuyên nghiệp
          </p>
        </div>
      </div>
      ...
      <div className="relative z-10 flex w-full items-center justify-center px-4 py-8 sm:px-6 lg:w-1/2">
        <div className="w-full max-w-md rounded-2xl border border-white/10 bg-[#121212]/80 p-6 backdrop-blur-md sm:p-8 lg:border-transparent lg:bg-transparent lg:p-0 lg:backdrop-blur-none">
          ...
          <button
            ...
            className="mb-4 flex w-full items-center justify-center gap-3 rounded-xl border border-gray-600 bg-white/5 px-4 py-3 text-sm font-medium text-white transition hover:bg-white/10"
          >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={submitting}
              className="w-full rounded-xl py-3 text-sm font-bold transition hover:scale-[1.02] disabled:opacity-50"
          ...
          <p className="mt-6 text-center text-sm text-gray-400">
            ...
            <button onClick={() => { setIsLogin(!isLogin); setError(""); setMessage(""); }} className="font-medium text-purple-400 hover:underline">
