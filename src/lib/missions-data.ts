...
const roadmap1: Roadmap = {
  ...
  missions: [
      ...
      incomePhases: [
        {
          ...
          estimatedIncome: "~10.700.000 VND (nếu đạt 20 đơn: lương 8tr + hoa hồng 2.7tr)",
          focus: "Học quy trình, build danh sách lead, shadow Phong chốt đơn",
        },
      ],
      checklist: [
        { id: "inc1-1", label: "Đã hiểu mức lương cơ bản 8 triệu/tháng" },
        { id: "inc1-2", label: "Đã hiểu cách tính hoa hồng 10%/đơn = 135.000 VND" },
    ...
    },
    {
      ...
      description: "Giai đoạn tăng tốc — lương tăng, hoa hồng tăng lên 15%, và bạn bắt đầu tự vận hành pipeline sale.",
      emoji: "🚀",
      incomePhases: [
        {
          phase: "Phát triển",
          ...
          estimatedIncome: "~18.000.000 - 19.000.000 VND (nếu đạt 36 đơn: lương 10-12tr + hoa hồng 7.29tr)",
          focus: "Tự vận hành pipeline, giảm hỏi Phong, bắt đầu upsell",
        },
      ],
      checklist: [
        { id: "inc2-1", label: "Đã hiểu mức lương tăng lên 10-12 triệu/tháng" },
        { id: "inc2-2", label: "Đã hiểu hoa hồng tăng lên 15%/đơn = 202.500 VND" },
    ...
    },
    {
      ...
      description: "Giai đoạn đỉnh cao — hoa hồng 20%, bonus vượt KPI, tự tạo lead và đào tạo người mới.",
      emoji: "⚔️",
      incomePhases: [
        {
          phase: "Chiến binh",
          ...
          commission: "20% / đơn chốt được",
          kpiMin: "50 đơn / tháng (điều kiện nhận 20% hoa hồng)",
          kpiTarget: "60 đơn / tháng",
          commissionPerDeal: "270.000 VND (20% x 1.350.000)",
          estimatedIncome: "~27.000.000 - 28.500.000 VND (nếu đạt 50 đơn: lương 13-15tr + hoa hồng 13.5tr)",
      ...
      checklist: [
        ...
        { id: "inc3-2", label: "Đã hiểu hoa hồng 20%/đơn = 270.000 VND + bonus vượt KPI" },
